...
## Parameters
- `promiseFn`: A promise-returning function
- `initialValue`: Optional initial value for the result signal
- `ultimately`: Optional callback to run in the promise's finally block
