...
> Last updated: 2026-06-19T14:36:52.698Z
 ...
 *
 * @see DerivedValueGetterWithSignals - The type of the value getter function
 * @see signal - For creating mutable source signals
 * @see effect - For registering functions to run when signal values change
 */
